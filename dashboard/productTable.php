                            ...
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <select name="category" class="form-control" id="productCetorgry">
                                    <?php
                                        ...
                                        // }
                                        // echo $output;
                                        $sql = 'SELECT * FROM cetorgry';
                                        $rs = conSQL::executeQuery($sql);
                                        while ($row = mysqli_fetch_array($rs)) 
                                            echo '<option value="'.$row['cetorgryID'].'">'.$row['cetorgryName'].'</option>';
                                    ?>
                                </select>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <button class="au-btn-filter product-filter"> <!-- product-filter -->
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small btn-product-edit" data-toggle="modal" data-target="#productEdit"> <!-- productEdit -->
